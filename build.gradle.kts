...
dependencies {
    ...
    // Aether Framework 0.3.4.0 - Django-like KMP framework with admin, auth, forms
    // 0.3.4.0 - Fix Vert.x body reading for Cloud Run (forms were returning empty data)
    implementation("codes.yousef.aether:aether-core-jvm:0.3.4.0")
    implementation("codes.yousef.aether:aether-web-jvm:0.3.4.0")
    implementation("codes.yousef.aether:aether-ui-jvm:0.3.4.0")
    implementation("codes.yousef.aether:aether-db-jvm:0.3.4.0")
    implementation("codes.yousef.aether:aether-auth-jvm:0.3.4.0")
    implementation("codes.yousef.aether:aether-forms-jvm:0.3.4.0")
    implementation("codes.yousef.aether:aether-admin-jvm:0.3.4.0")
