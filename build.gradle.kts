...
dependencies {
    ...
    // Aether Framework 0.3.3.0 - Django-like KMP framework with admin, auth, forms
    // 0.3.3.0 - ModelAdmin multilineFields, excludeFields, defaultValues
    implementation("codes.yousef.aether:aether-core-jvm:0.3.3.0")
    implementation("codes.yousef.aether:aether-web-jvm:0.3.3.0")
    implementation("codes.yousef.aether:aether-ui-jvm:0.3.3.0")
    implementation("codes.yousef.aether:aether-db-jvm:0.3.3.0")
    implementation("codes.yousef.aether:aether-auth-jvm:0.3.3.0")
    implementation("codes.yousef.aether:aether-forms-jvm:0.3.3.0")
    implementation("codes.yousef.aether:aether-admin-jvm:0.3.3.0")
