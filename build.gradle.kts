...
dependencies {
    ...
    // Aether Framework 0.3.1.0 - Django-like KMP framework with admin, auth, forms
    implementation("codes.yousef.aether:aether-core-jvm:0.3.1.1")
    implementation("codes.yousef.aether:aether-web-jvm:0.3.1.1")
    implementation("codes.yousef.aether:aether-ui-jvm:0.3.1.1")
    implementation("codes.yousef.aether:aether-db-jvm:0.3.1.1")
    implementation("codes.yousef.aether:aether-auth-jvm:0.3.1.1")
    implementation("codes.yousef.aether:aether-forms-jvm:0.3.1.1")
    implementation("codes.yousef.aether:aether-admin-jvm:0.3.1.1")
